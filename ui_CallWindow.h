...
public:
    ...
    void setupUi(QDialog *CallWindow)
    {
        ...
        gridLayout->addLayout(videoVLayout, 2, 0, 2, 2);
        ...
        gridLayout->addLayout(previewVLayout, 3, 1, 1, 1);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Images/images/icon_video.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Images/images/icon_listen.png"), QSize(), QIcon::Normal, QIcon::Off);
        listenButton->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("images/icon_video_ai.png"), QSize(), QIcon::Normal, QIcon::Off);
        videoAiButton->setIcon(icon3);
        ...
        gridLayout->addLayout(videoButtonGLayout, 1, 0, 1, 1);
